...
(function () {
  for (var index = 0; index < Object.keys(object).length; index++)
    properties.push(Object.keys(object)[index]);
})();
*/
  ...
  return {
    visitor: {
      ...
      ForInStatement: function (path) {
        var
          node, scope, index, keys, indexDeclaration, declarations, left, body;
